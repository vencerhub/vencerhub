          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center relative z-10">
            <div className="lg:col-span-8 space-y-4">
              ...
              <p className="text-sm md:text-base text-zinc-300 leading-relaxed font-medium">
                <strong>Finalidade do Aplicativo:</strong> O <strong>Vencer HUB ERP</strong> é o sistema integrado de gestão empresarial da Vencer Hub Produções. Ele centraliza o CRM de clientes, planejamento de projetos audiovisuais, acompanhamento financeiro com DRE por projeto, checklists pós-produção, gestão de equipe e inteligência de dados.
              </p>
            ...
            <div className="lg:col-span-4 flex flex-col items-center lg:items-end justify-center gap-4 text-center lg:text-right border-t lg:border-t-0 lg:border-l border-white/10 pt-6 lg:pt-0 lg:pl-8">
              ...
              >
                <ShieldCheck className="w-4 h-4" /> Acessar Vencer HUB ERP
              </Link>
            </div>
          </div>
        </div>
